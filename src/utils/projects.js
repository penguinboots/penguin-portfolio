...
const mimikyu = {
  ...
  live: "mimikyus-day-off.vercel.app",
...
const shortly = {
  ...
  live: "shortly-url-shortener-five.vercel.app",
...
const bytes = {
  ...
  image: "",
  description: "Midterm Group Project: A full-stack web app for a fictional robot-themed restaurant with Twilio integration.",
  live: null,
